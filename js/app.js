// 全局变量
let selectedAPIs = JSON.parse(localStorage.getItem('selectedAPIs') || '["qilin","niuniu","fengcao","maotai","tyyszy","dyttzy","bfzy","ruyi","heimuer","baidu","dbzy","zy360","wolong","jisu","mozhua","mdzy"]'); // 默认选中资源
